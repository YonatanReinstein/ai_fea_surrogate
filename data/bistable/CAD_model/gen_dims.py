...
Run from the project root: python data/bistable/CAD_model/gen_dims.py
...
from data.bistable.boundary_conditions import tile_grid

CAD_DIR = Path(__file__).parent


def gen_dims(default: float = 0.3, lo: float = 0.01, hi: float = 0.5) -> dict:
    NX, NY, NZ = tile_grid()
    N = NX * NY * NZ
...
if __name__ == "__main__":
    ...
    parser.add_argument("--max", type=float, default=0.5, dest="hi")
